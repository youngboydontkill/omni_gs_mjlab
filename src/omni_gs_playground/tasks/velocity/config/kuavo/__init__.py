...
from .rl_cfg import (
  ...
  kuavo_s54_rough_ssr_ppo_runner_cfg,
)
...
register_mjlab_task(
  task_id="Kuavo-S54-Rough-SSR",
  env_cfg=kuavo_s54_rough_ssr_env_cfg(),
  play_env_cfg=kuavo_s54_rough_ssr_env_cfg(play=True),
  rl_cfg=kuavo_s54_rough_ssr_ppo_runner_cfg(),
  runner_cls=VelocityOnPolicyRunner,
)
...
register_mjlab_task(
  task_id="Kuavo-S54-AME",
  env_cfg=kuavo_s54_ame_env_cfg(),
  play_env_cfg=kuavo_s54_ame_env_cfg(play=True),
  rl_cfg=kuavo_s54_ame_ppo_runner_cfg(),
  runner_cls=VelocityOnPolicyRunner,
)
